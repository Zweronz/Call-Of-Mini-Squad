...
public class UtilUIArenaRankPointInfo : MonoBehaviour
{
	[SerializeField]
	...
	private UtilUIArenaRankPointInfo_GOCLICK_Delegate _event;
	...
	public void UpdatePoint(string _str)
	{
		point.text = _str;
	}
	...
	public void BlindFuntion(UtilUIArenaRankPointInfo_GOCLICK_Delegate _dele)
	{
		_event = _dele;
	}
