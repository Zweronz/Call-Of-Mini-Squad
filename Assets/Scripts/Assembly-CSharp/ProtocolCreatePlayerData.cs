...
public class ProtocolCreatePlayerData : Protocol
{
	public override string GetRequest()
	{
		Hashtable hashtable = new Hashtable();
		hashtable["userId"] = DataCenter.Save().uuid;
		hashtable["userName"] = DataCenter.Save().userName;
		hashtable["local"] = UIUtil.GetProtocolLaguageCode();
		...
		Debug.LogWarning("--------ProtocolCreatePlayerData jsonText : " + text);
		return text;
	}
