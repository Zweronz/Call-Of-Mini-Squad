...
o.uv_MainTex = 0.0;
o.uv_Blend_Texture = 0.0;
o.uv_Blend_Texture01 = 0.0;
o.color = 0.0;
o.uv_MaskTex = 0.0;
...
float4 Multiply4=SplatAlpha0 * IN.color;
float4 Multiply2=Multiply11 * Multiply4;
float4 Sampled2D0=tex2D(_MaskTex,IN.uv_MaskTex.xy);
float4 Multiply13=Multiply2 * Sampled2D0;
